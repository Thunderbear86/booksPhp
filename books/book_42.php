...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p class="card-text"><?= $book->bookText ?></p>
            <p class="card-text"><span class="fw-bold">Pris:</span> kr. <?= number_format($book->bookPrice, 2, ',', '.') ?></p>
            <p class="card-text"><span class="fw-bold">Forfatter:</span> <?= $book->author ?></p>
            <p class="card-text"><span class="fw-bold">Udgivelses dato:</span> <?= date("d-m-Y", strtotime($book->publicationDate)) ?></p>
